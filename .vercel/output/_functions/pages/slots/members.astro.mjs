...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Listado de miembros" }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "MembersList", Example, { "users": people, "client:load": true, "client:component-hydration": "load", "client:component-path": "@/components/Members", "client:component-export": "default" })} ` })}`;
}, "C:/Users/Alex/Documents/Astro/astro-calendar-main/src/pages/slots/members/index.astro", void 0);

const $$file = "C:/Users/Alex/Documents/Astro/astro-calendar-main/src/pages/slots/members/index.astro";
const $$url = "/slots/members";
